...
class AppDelegate: FlutterAppDelegate {
    ...
    func setupCoreInApplicationSupport() {
        ...
        let bundleCorePath = bundleURL.appendingPathComponent("Contents/MacOS/FoxCloudCore")
        let appSupportCorePath = appSupportURL.appendingPathComponent("com.foxcloud.app/cores/FoxCloudCore")
        ...
        do {
            ...
            if needsUpdate {
                ...
                if setCorePermissions(corePath: appSupportCorePath.path) {
                    print("FoxCloudCore updated to: \(appSupportCorePath.path)")
                }
            } else {
                ...
                if let posixPerms = attrs?[.posixPermissions] as? NSNumber {
                    ...
                    if (posixPerms.uint16Value & 0o4000) == 0 {
                        ...
                        print("FoxCloudCore already up-to-date with correct permissions")
                    }
                }
            }
        } catch {
    ...
    func showPermissionRequiredAlert() {
        ...
        alert.informativeText = "FoxCloud requires administrator privileges to set up the network core. The application cannot run without these permissions.\n\nPlease restart the application and grant administrator access when prompted."
