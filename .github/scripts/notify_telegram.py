...
def format_release_message(version, commits, release_url, is_stable):
    ...
    release_type = "FoxCloud. Stable Version on GitHub" if is_stable else "FoxCloud. PreRelease Version on GitHub"
...
def main():
    ...
    version_clean = version.lstrip('v')
    simple_message = f"Новый релиз!❤️\nFoxCloud {version_clean}\nПосмотреть: https://t.me/FoxCloud"
