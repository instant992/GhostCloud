...
bool globalModeEnabled(Ref ref) {
  ...
  final value = profile?.providerHeaders['foxcloud-globalmode'];
...
bool hasServiceInfoData(Ref ref) {
  final profile = ref.watch(currentProfileProvider);
  final value = profile?.providerHeaders['foxcloud-servicename'];
  return value != null && value.isNotEmpty;
}
...
bool hasServerInfoData(Ref ref) {
  final profile = ref.watch(currentProfileProvider);
  final value = profile?.providerHeaders['foxcloud-serverinfo'];
  return value != null && value.isNotEmpty;
}
...
String? backgroundUrl(Ref ref) {
  final profile = ref.watch(currentProfileProvider);
  return profile?.providerHeaders['foxcloud-background'];
}
