...
import 'package:foxcloud/views/dashboard/widgets/announce_widget.dart';
import 'package:foxcloud/views/dashboard/widgets/metainfo_widget.dart';
import 'package:foxcloud/views/dashboard/widgets/public_ip.dart';
import 'package:foxcloud/views/dashboard/widgets/widgets.dart';
...
enum DashboardWidget {
  ...
  subscriptionManage(
    GridItem(
      crossAxisCellCount: 8,
      child: SubscriptionManageWidget(),
    ),
  ),
  serviceInfo(
    GridItem(
