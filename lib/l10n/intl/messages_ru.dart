...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "disclaimerDesc": MessageLookupByLibrary.simpleMessage(
      "Приложение распространяется как свободное программное обеспечение и не предназначено для обхода законодательных ограничений. Автор не поддерживает и не поощряет использование программы в целях, запрещённых местным законодательством. Пользователь несёт полную ответственность за способы и цели использования.\n\nПродолжая использование приложения, вы подтверждаете, что ознакомлены с данным дисклеймером и соглашаетесь с ним.",
    ),
    ...
    "gratitude": MessageLookupByLibrary.simpleMessage("Особая благодарность"),
    ...
    "otherContributors": MessageLookupByLibrary.simpleMessage("Авторы"),
    ...
    "testDelay": MessageLookupByLibrary.simpleMessage("Тест"),
    "connectedDevices": MessageLookupByLibrary.simpleMessage("Подключено устройств"),
    "deviceLimit": MessageLookupByLibrary.simpleMessage("Лимит устройств"),
    "renewSubscription": MessageLookupByLibrary.simpleMessage("Информация о подписке"),
    "noDevices": MessageLookupByLibrary.simpleMessage("Нет подключённых устройств"),
    "deviceOs": MessageLookupByLibrary.simpleMessage("ОС"),
    "deviceModel": MessageLookupByLibrary.simpleMessage("Модель"),
    "loadingDevices": MessageLookupByLibrary.simpleMessage("Загрузка устройств..."),
    "errorLoadingDevices": MessageLookupByLibrary.simpleMessage("Ошибка загрузки устройств"),
    "trafficUsed": MessageLookupByLibrary.simpleMessage("Использовано"),
    "unlimitedTraffic": MessageLookupByLibrary.simpleMessage("Безлимитный трафик"),
  };
}
