...
const List<DashboardWidget> defaultDashboardWidgets = [
  ...
  DashboardWidget.subscriptionManage,
  DashboardWidget.bypassSettings,
  DashboardWidget.serverList,
];
...
class ThemeProps with _$ThemeProps {
  const factory ThemeProps({
    ...
    @Default(DynamicSchemeVariant.neutral) DynamicSchemeVariant schemeVariant,
