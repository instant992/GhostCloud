...
import 'package:foxcloud/clash/core.dart';
import 'package:foxcloud/common/common.dart';
import 'package:foxcloud/enum/enum.dart';
import 'package:foxcloud/utils/device_info_service.dart';
...
extension ProfileExtension on Profile {
  ...
  Future<Profile> update({bool shouldSendHeaders = true}) async {
    ...
    response.headers.forEach((name, values) {
      if (name.toLowerCase().startsWith('foxcloud-') && values.isNotEmpty) {
